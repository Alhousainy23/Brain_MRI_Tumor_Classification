...
from config import (DEVICE,NUM_CLASSES,NUM_EPOCHS,LEARNING_RATE,WEIGHT_DECAY,EARLY_STOPPING_PATIENCE,
                    EARLY_STOPPING_MIN_DELTA,RESNET18_MODEL_PATH,RESNET18_HISTORY_PATH)
# ============================================================
# Early Stopping
# ============================================================
class EarlyStopping:
...
def train_resnet18():
    ...
    if torch.cuda.is_available():print(f"GPU Name: "f"{torch.cuda.get_device_name(0)}")
    # ========================================================
    # Create DataLoaders
    # ========================================================
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if is_best:
            torch.save({"model_state_dict":model.state_dict(),"optimizer_state_dict":optimizer.state_dict(),"epoch":epoch + 1,
                        "val_loss":val_loss,"val_accuracy":val_accuracy},RESNET18_MODEL_PATH)
    ...
    # ========================================================
    torch.save(history,RESNET18_HISTORY_PATH)
    # ========================================================
    # Training Completed
    # ========================================================
    print("\n" + "=" * 60)
    ...
    print("=" * 60)
    print("\nBest Model Saved At:")
    print(RESNET18_MODEL_PATH)
    print("\nTraining History Saved At:")
    print(RESNET18_HISTORY_PATH)
# ============================================================
# Main
# ============================================================
if __name__ == "__main__":train_resnet18()